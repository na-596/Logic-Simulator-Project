    ...
    if not options:  # no option given, use the graphical user interface
        ...
        if parser.parse_network():
            ...
            if language in [
                ...
                "zh_CN.utf8", "zh_CN.UTF-8", "zh_CN",
                "CHINESE", "Chinese", "chinese"
            ]:
                lang = wx.LANGUAGE_CHINESE_SIMPLIFIED
            elif language in [
                "ta_IN.utf8", "ta_IN.UTF-8", "ta_IN",
                "TAMIL", "Tamil", "tamil"
            ]:
                lang = wx.LANGUAGE_TAMIL
            elif language in [
                "yo_NG.utf8", "yo_NG.UTF-8", "yo_NG",
                "YORUBA", "Yoruba", "yoruba"
            ]:
                lang = wx.LANGUAGE_YORUBA
            elif language in [
                "kn_IN.utf8", "kn_IN.UTF-8", "kn_IN",
            ...
            gui = Gui(wx.GetTranslation("Logic Simulator"),
                      path, names, devices, network,
                      monitors, language)
            gui.Show(True)
            app.MainLoop()
