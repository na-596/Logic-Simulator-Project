...
class Scanner:
    ...
    def __init__(self, path, names):
        ...
        self.symbol_type_list = [
            self.COMMA, self.SEMICOLON, self.COLON, self.ARROW, self.DOT,
        ...
        self.keywords_list = [
            "DEVICES", "CONNECT", "MONITOR", "END", "CLOCK", "SWITCH", "AND",
            "NAND", "OR", "NOR", "XOR", "DTYPE", "DATA", "CLK", "SET", "CLEAR",
            "Q", "QBAR", "I1", "I2", "I3", "I4", "I5", "I6", "I7", "I8", "I9",
            "I10", "I11", "I12", "I13", "I14", "I15", "I16", "SIGGEN"
        ]
        ...
        [
            ...
            self.I14_ID, self.I15_ID, self.I16_ID, self.SIGGEN_ID
        ...
        self.gate_port_id_list = [
            self.I1_ID, self.I2_ID, self.I3_ID, self.I4_ID, self.I5_ID,
            self.I6_ID, self.I7_ID, self.I8_ID, self.I9_ID,
            self.I10_ID, self.I11_ID, self.I12_ID, self.I13_ID,
        ...
        while self.current_character in ["/", "#", "\n"]:
            if self.current_character == "/":
                ...
                if self.current_character == "*":
                    ...
                    self.advance()
                    while not (
                        self.current_character == "/" and not comment_flag
                    ):
                        if self.current_character == "\n":
                            self.line_number += 1
                            self.position = 0
    ...
    def get_waveform(self):
        """Seek the next waveform in input_file.

        Return the waveform string and the next non-numeric character.
        """
        num_str = ''
        while self.current_character.isdigit():
            num_str += self.current_character
    ...
    def print_error(self, symbol):
        ...
        Returns a string with the error message and a caret (^)
        ...
        if 1 <= symbol.line_number <= len(self.lines) - 1:
            message += (
                self.lines[symbol.line_number - 1] +
                " " * (symbol.position - 1) + "^"
            )
